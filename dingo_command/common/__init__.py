...
ironic_opts = [
    ...
    cfg.StrOpt(
        "password", default="dKF6StAnNfzTQjXVX3MIGWSRi0JagLxAKZDK6zLk", help="password"
    ),
...
nova_opts = [
    ...
    cfg.StrOpt(
        "password", default="XModTf5fcvUw7aAr3CUBBVdO38WQS15QQwNqVjGJ", help="password"
    ),
    cfg.StrOpt("region_name", default="RegionOne", help="region name"),
]
# 注册nova配置
...
cloudkitty_opts = [
    ...
    cfg.StrOpt(
        "password", default="LRnxEqGtZqtBC2zmwDwg9510x1sGnMPB4eOOQa0w", help="password"
    ),
    cfg.StrOpt("region_name", default="RegionOne", help="region name"),
]
# 注册cloudkitty配置
...
default_opts = [
    ...
    cfg.StrOpt(
        "center_transport_url",
        default=None,
        help="the region one openstack rabbit mq url",
    ),
    cfg.BoolOpt(
        "center_region_flag", default=False, help="the region is center region"
    ),
    cfg.StrOpt("region_name", default=None, help="the openstack region name"),
    cfg.StrOpt(
        "cluster_work_dir",
        default="/var/lib/dingo-command",
