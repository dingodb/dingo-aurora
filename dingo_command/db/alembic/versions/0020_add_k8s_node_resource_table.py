...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("cpu_slot_total", sa.String(length=128), nullable=True, comment='cpu slot 总量'),
        sa.Column("cpu_slot_used", sa.String(length=128), nullable=True, comment='cpu slot 已用量'),
