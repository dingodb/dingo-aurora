...
op.create_table(
    ...
    sa.Column("is_root_account", sa.Boolean(),  nullable=False, server_default=sa.text('0'), comment='是否是主账号'),
    ...
    sa.Column("instance_create_time", sa.DateTime(), nullable=True, comment='底层容器实例创建时间'),
